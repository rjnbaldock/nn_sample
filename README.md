...
| T | 1.0e-4          | Dimensionless temperature T = 1.0/bet |
...
| traj_len | 100      | The number of time steps to use for each trajector |
| nbridge | 100       | Number of bridging distributions to use. Including sampling the distribution corresponding to the true potential, and the quadratic approximation potential, the nbridge+2 distributions are sampled |
